...
declare function defineModule<S, M extends IMutationsPayload, A extends IActionsPayload, G extends IGettersPayload>(name: string, state: S, { actions, mutations, getters }: {
    actions: A;
    mutations: M;
    getters: G;
}): {
...
declare function defineModule<S, M extends IMutationsPayload, A extends IActionsPayload>(name: string, state: S, { actions, mutations }: {
    actions: A;
    mutations: M;
}): {
    actions: ReturnedActions<A>;
...
declare function defineModule<S, M extends IMutationsPayload, G extends IGettersPayload>(name: string, state: S, { mutations, getters }: {
    mutations: M;
    getters: G;
}): {
    getters: ReturnedGetters<G>;
...
declare function defineModule<S, A extends IActionsPayload, G extends IGettersPayload>(name: string, state: S, { actions, getters }: {
    actions: A;
    getters: G;
}): {
    getters: ReturnedGetters<G>;
...
declare function defineModule<S, M extends IMutationsPayload>(name: string, state: S, { mutations }: {
    mutations: M;
}): {
    mutations: ReturnedMutations<M>;
    state: S;
...
declare function defineModule<S, A extends IActionsPayload>(name: string, state: S, { actions }: {
    actions: A;
}): {
    actions: ReturnedActions<A>;
    state: S;
